...
```{r}
(test_result <-chisq.test(x = grade_data$`Observed.Frequency`, p = grade_data$Percentage))
...
Yes, we reject the null hypothesis at the 0.10 alpha level because our X-squared statistic = 11.667, which is greater than 9.236.
